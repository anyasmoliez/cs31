...
namespace cs31
{
    ...
    void Board::markTied()
    {
        ...
        if ( mHumanRoundsWon == mComputerRoundsWon) { //if rounds won are equal, tie game and game is over
            mHumanWon =true;
            mComputerWon = true;
            mGameOver = true;
        }
    ...
    void Board::markHumanAsWinner()
    {
        ...
        if ( mHumanRoundsWon > mComputerRoundsWon) { //if human wins more rounds, human won the game and game is over
            mHumanWon = true;
            mComputerWon = false;
            mGameOver = true;
        }
    ...
    void Board::markComputerAsWinner()
    {
        ...
        if ( mHumanRoundsWon < mComputerRoundsWon) { //if computer wins more rounds, computer won the game and game is over
            mComputerWon = true;
            mHumanWon = false;
            mGameOver = true;
        }
    ...
    bool Board::isGameOver( ) const //game is over if markTied, markHumanAsWinner, markComputerAsWinner have been called
    {
        if (mGameOver == true)
    ...
    {
        if (mGameOver == true && mHumanWon == true && mComputerWon == false) //if game is over, and mHumanWon is true, human won
            return(true);
        else
            return false;
    }
    ...
    {
        if (mGameOver == true && mHumanWon == false && mComputerWon == true)//if game is over, and mComputerWon is true, computer won
            return(true);
        else
            return false;
    }
