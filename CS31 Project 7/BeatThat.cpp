...
namespace cs31
{
    ...
    void BeatThat::humanPlay( Die d1, Die d2 )
    {
        ...
        mHuman.roll(d1, d2); //rolls the die for human player
    ...
    void BeatThat::computerPlay( Die d1, Die d2 )
    {
        ...
        mComputer.roll(d1, d2); //rolls the die for computer player
    ...
    BeatThat::GAMEOUTCOME  BeatThat::determineGameOutcome( ) const
    {
        ...
        if (turnsLeft()!=0) {
            GAMEOUTCOME result = GAMEOUTCOME::GAMENOTOVER;//if there are still turns left, game is not over
            return result;
        }
        
        
        else if ( mHuman.getRoundsWon() > mComputer.getRoundsWon()) {//if more rounds won by human player, human won game
        ...
        else if ( mHuman.getRoundsWon() < mComputer.getRoundsWon()) {//if more rounds won by computer player, computer won game
            ...
            GAMEOUTCOME result = GAMEOUTCOME::TIEDGAME;//otherwise, this is a tied game
